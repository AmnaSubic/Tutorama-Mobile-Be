...
module.exports.handler = async (event) => {
    ...
    try {
        ...
        const result3 = equijoin(users.users, result2, 'user', 'tutor',
            ({firstname, lastname, istutor}, {c, service, student, date, start, end, place, price, subject, name, tutor, level}) => ({c, service, student, date, start, end, place, price, subject, name, tutor, firstname, lastname, level, istutor}));
